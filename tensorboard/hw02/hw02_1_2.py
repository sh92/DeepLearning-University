...
with tf.name_scope('Layer3'):
   W3 = tf.Variable(tf.random_normal([l2_class, l3_class]), name='weight3')
...
with tf.name_scope('Layer4'):
   W4 = tf.Variable(tf.random_normal([l3_class, l4_class]), name='weight4')
...
with tf.name_scope('Layer5'):
   W5 = tf.Variable(tf.random_normal([l4_class, nb_class]), name='weight5')
...
with tf.Session() as sess:
   ...
   writer = tf.summary.FileWriter("./board2_1_2");
